...
Este es un agente de chatbot inteligente desarrollado con LangGraph. El agente cuenta con memoria persistente, herramientas especializadas y capacidades de integración con Google Sheets para gestión de clientes.
